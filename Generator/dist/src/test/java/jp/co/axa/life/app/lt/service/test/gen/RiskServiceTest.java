...
import jp.co.axa.life.app.lt.service.gen.RiskService;

@ContextConfiguration(locations="classpath:jp/co/axa/life/app/lt/service/resource/gen/RiskServiceTest-context.xml")
public class RiskServiceTest extends BaseDaoTest{
    ...
    public void testSelectByCondition() throws Exception {
		...
		//call Dao
		List<RiskJsonRecord> result= riskService.selectByCondition(condition);
