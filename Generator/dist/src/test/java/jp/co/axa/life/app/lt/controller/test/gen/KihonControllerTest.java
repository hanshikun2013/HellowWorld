...
import jp.co.axa.life.app.lt.controller.gen.KihonController;

@ContextConfiguration(locations="classpath:jp/co/axa/life/app/lt/controller/resource/gen/KihoncontrollerTest-context.xml")
public class KihonControllerTest extends BaseDaoTest{

	/** テスト対象のDao */
	@Autowired
	private KihonController kihonController;
    ...
    public void testSelectByCondition() throws Exception {
		...
		//call Dao
		List<KihonJsonRecord> result= kihonController.selectByCondition(condition);
