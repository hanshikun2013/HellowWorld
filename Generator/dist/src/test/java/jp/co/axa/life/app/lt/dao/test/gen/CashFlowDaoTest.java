...
@ContextConfiguration(locations="classpath:jp/co/axa/life/app/lt/dao/resource/gen/CashFlowDaoTest-context.xml")
public class CashFlowDaoTest extends BaseDaoTest{
    ...
    public void testSelectByCondition() throws Exception {
		...
		//call Dao
		List<CashFlowRecord> result= cashFlowDao.selectByCondition(condition);
