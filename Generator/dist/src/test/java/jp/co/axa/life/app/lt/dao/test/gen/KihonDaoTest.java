...
@ContextConfiguration(locations="classpath:jp/co/axa/life/app/lt/dao/resource/gen/KihonDaoTest-context.xml")
public class KihonDaoTest extends BaseDaoTest{
    ...
    public void testSelectByCondition() throws Exception {
		...
		//call Dao
		List<KihonRecord> result= kihonDao.selectByCondition(condition);
