...
import jp.co.axa.life.app.lt.controller.gen.CashFlowController;

@ContextConfiguration(locations="classpath:jp/co/axa/life/app/lt/controller/resource/gen/CashFlowcontrollerTest-context.xml")
public class CashFlowControllerTest extends BaseDaoTest{
    ...
    public void testSelectByCondition() throws Exception {
		...
		//call Dao
		List<CashFlowJsonRecord> result= cashFlowController.selectByCondition(condition);
