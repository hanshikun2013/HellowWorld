...
public class 	PlanFamilyCollection
{
    /**
     * ID
     */
     ...
     * 入社年齢
     */
 	@JsonProperty("enterCompanyAge")
	private String enterCompanyAge;   
    /**
     * 性別名
     */
     ...
     * 続柄名
     */
 	@JsonProperty("zokugaraName")
	private String zokugaraName;   
	 ...
	 * @return 入社年齢
	 */
	public String getEnterCompanyAge() {
		return enterCompanyAge;
	}
	
	/**
	 * 入社年齢を設定します。
	 * @param enterCompanyAge 入社年齢
	 */
	public void setEnterCompanyAge(String enterCompanyAge) {
		this.enterCompanyAge = enterCompanyAge;
	}
	 ...
	 * @return 続柄名
	 */
	public String getZokugaraName() {
		return zokugaraName;
	}
	
	/**
	 * 続柄名を設定します。
	 * @param zokugaraName 続柄名
	 */
	public void setZokugaraName(String zokugaraName) {
		this.zokugaraName = zokugaraName;
	}
}	
