...
public class Datamodel2TableCopier{
	 ...
	 */
	static public TLrms2lfKihon transferTLrms2LfKihon(LtPlanCollection ltPlanCollection, Lrsc0301Collection lrsc0301Collection, Lrsc0304Collection lrsc0304Collection, Lrsc030501Collection lrsc030501Collection){
		//パラメターのNULLチェック：	
		if( ltPlanCollection == null)
			ltPlanCollection =new LtPlanCollection ();
		if( lrsc0301Collection == null)
			lrsc0301Collection =new Lrsc0301Collection ();
		...
		//FROM:画面データモデル:Lrsc0301 入力:生活費（月額・円） key名:livingCost 型:NUMBER 備考: 
		//TO:テーブル.テーブル:T_LRMS_2LF_KIHON 論理:必要資金 生活費 物理:HYSKN_LIFE 属性:Number 桁数:11 少数: 備考:×10000
		//TODO:
		result.setHysknLife(LtSvUtils.multiply(ConverterUtility.convert(java.math.BigDecimal.class,lrsc0301Collection.getLivingCost()),LtSvConst.TEN_THOUSAND));

		//FROM:画面データモデル:Lrsc0304 入力:世帯主収入 key名:incomeHh 型:NUMBER 備考: 
		//TO:テーブル.テーブル:T_LRMS_2LF_KIHON 論理:準備済資金 収入（主） 物理:JZSKN_SHUNYU_MAIN 属性:Number 桁数:11 少数: 備考:×10000
		//TODO:
		result.setJzsknShunyuMain(LtSvUtils.multiply(ConverterUtility.convert(java.math.BigDecimal.class,lrsc0304Collection.getIncomeHh()),LtSvConst.TEN_THOUSAND));

		//FROM:画面データモデル:Lrsc0304 入力:配偶者収入 key名:incomeSp 型:NUMBER 備考: 
		//TO:テーブル.テーブル:T_LRMS_2LF_KIHON 論理:準備済資金 収入（配） 物理:JZSKN_SHUNYU_SP 属性:Number 桁数:11 少数: 備考:×10000
		//TODO:
		result.setJzsknShunyuSp(LtSvUtils.multiply(ConverterUtility.convert(java.math.BigDecimal.class,lrsc0304Collection.getIncomeSp()),LtSvConst.TEN_THOUSAND));
		...
		//TODO:
		result.setJzsknTaishokukinMain(LtSvUtils.multiply(ConverterUtility.convert(java.math.BigDecimal.class,lrsc0304Collection.getRetirementMoneyHh()),LtSvConst.TEN_THOUSAND));
		...
		//TODO:
		result.setJzsknTaishokukinSp(LtSvUtils.multiply(ConverterUtility.convert(java.math.BigDecimal.class,lrsc0304Collection.getRetirementMoneySp()),LtSvConst.TEN_THOUSAND));
		...
		//TODO:
		result.setJzsknYochokin(LtSvUtils.multiply(ConverterUtility.convert(java.math.BigDecimal.class,lrsc0304Collection.getDeposit()),LtSvConst.TEN_THOUSAND));

		//FROM:画面データモデル:Lrsc0304 入力:その他収入 key名:otherIncome 型:NUMBER 備考: 
		//TO:テーブル.テーブル:T_LRMS_2LF_KIHON 論理:準備済資金 その他 物理:JZSKN_OTHER 属性:Number 桁数:11 少数: 備考:×10000
		//TODO:
		result.setJzsknOther(LtSvUtils.multiply(ConverterUtility.convert(java.math.BigDecimal.class,lrsc0304Collection.getOtherIncome()),LtSvConst.TEN_THOUSAND));
		...
		//TODO:
		//result.setSystemCreateDate(ConverterUtility.convert(String.class,登録時のSYSDATEをセットCollection.get()));

		//FROM:画面データモデル:登録時のSYSDATEをセット 入力: key名: 型: 備考: 
		//TO:テーブル.テーブル:T_LRMS_2LF_KIHON 論理:システム更新日時 物理:SYSTEM_UPDATE_DATE 属性:Date 桁数:　 少数: 備考:
		//TODO:
		//result.setSystemUpdateDate(ConverterUtility.convert(String.class,登録時のSYSDATEをセットCollection.get()));
	...
	static public TLrms2lfHysknLife transferTLrms2LfHysknLife(LtPlanCollection ltPlanCollection, Lrsc030201Collection lrsc030201Collection, Collection collection){
		...
		//FROM:画面データモデル:Lrsc030201 入力:TODO key名:TODO 型: 備考: 
		//TO:テーブル.テーブル:T_LRMS_2LF_HYSKN_LIFE 論理:SEQ 物理:SEQ 属性:Number 桁数:1 少数: 備考:
		//TODO:
		result.setSeq(ConverterUtility.convert(java.math.BigDecimal.class,lrsc030201Collection.getTODO()));
	...
	static public TLrms2lfHysknEvent transferTLrms2LfHysknEvent(LtPlanCollection ltPlanCollection, Lrsc030203Collection lrsc030203Collection){
		...
		//TODO:
		result.setEventHitsuyoKingaku(LtSvUtils.multiply(ConverterUtility.convert(java.math.BigDecimal.class,lrsc030203Collection.getHobbyCost()),LtSvConst.TEN_THOUSAND));
	...
	static public TLrms2lfHysknOther transferTLrms2LfHysknOther(LtPlanCollection ltPlanCollection, Lrsc030204Collection lrsc030204Collection){
		...
		//TODO:
		result.setOtherHitsuyoKingaku(LtSvUtils.multiply(ConverterUtility.convert(java.math.BigDecimal.class,lrsc030204Collection.getOtherCost()),LtSvConst.TEN_THOUSAND));
	...
	static public TLrms2lfJzsknNkknm transferTLrms2LfJzsknNkknm(LtPlanCollection ltPlanCollection, LtPensionCollection ltPensionCollection){
		...
		//TODO:
		result.setNenshu(LtSvUtils.multiply(ConverterUtility.convert(java.math.BigDecimal.class,ltPensionCollection.getIncome()),LtSvConst.TEN_THOUSAND));
	...
	static public TLrms2lfJzsknShunyu transferTLrms2LfJzsknShunyu(LtPlanCollection ltPlanCollection, Lrsc030502Collection lrsc030502Collection){
		...
		//TODO:
		result.setNenshuGaku(LtSvUtils.multiply(ConverterUtility.convert(java.math.BigDecimal.class,lrsc030502Collection.getIncomeAmount()),LtSvConst.TEN_THOUSAND));
	...
	static public TLrms2lfJzsknOther transferTLrms2LfJzsknOther(LtPlanCollection ltPlanCollection, Lrsc030503Collection lrsc030503Collection){
		...
		//TODO:
		result.setShunyuGaku(LtSvUtils.multiply(ConverterUtility.convert(java.math.BigDecimal.class,lrsc030503Collection.getOtherAmount()),LtSvConst.TEN_THOUSAND));
